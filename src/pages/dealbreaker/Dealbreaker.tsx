...
export default function DealBreakers() {
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-[#1E073A] px-6 pb-[calc(env(safe-area-inset-bottom)+1.5rem)] pt-[calc(env(safe-area-inset-top)+1.5rem)] text-white">
      {/* Decorative elements */}
...
function CompletionScreen() {
  ...
  return (
    <div className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden bg-white px-6 pb-[calc(env(safe-area-inset-bottom)+1.5rem)] pt-[calc(env(safe-area-inset-top)+1.5rem)]">
      {/* Decorative elements */}
