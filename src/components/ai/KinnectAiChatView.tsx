...
export const KinnectAiChatView: React.FC<KinnectAiChatViewProps> = ({
  ...
  return (
    <div className="flex min-h-[calc(100vh-148px)] flex-col overflow-hidden rounded-t-[24px] border border-[#E6DDF0] bg-white shadow-[0_20px_60px_rgba(43,16,77,0.08)]">
      <div className="bg-gradient-to-r from-[#55288D] via-[#7A1FA2] to-[#C2188B] px-4 py-4 text-white">
        ...
        <p className="mt-1 text-xs text-white/80">
          Ask for dating advice, message ideas, profile help, or community guidance.
        </p>
      </div>
